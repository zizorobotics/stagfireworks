              ...
              <div className="store-detail-box">
                ...
                <div className="social-links" style={{ marginTop: '1.5rem' }}>
                  ...
                  <div style={{ display: 'flex', gap: '1rem', marginTop: '0.8rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                    ...
                    <a href="https://www.facebook.com/profile.php?id=100075841641042" target="_blank" rel="noreferrer" title="Facebook" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '56px', height: '56px', borderRadius: '50%', background: '#1877F2', color: 'white', textDecoration: 'none', boxShadow: '0 4px 15px rgba(24, 119, 242, 0.4)' }}>
                    ...
                    <a href="https://www.tiktok.com/@stagfireworks5" target="_blank" rel="noreferrer" title="TikTok" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '56px', height: '56px', borderRadius: '50%', background: '#000', color: 'white', border: '2px solid #333', textDecoration: 'none', boxShadow: '0 4px 15px rgba(255, 255, 255, 0.1)' }}>
